    ...
    <div className="space-y-6">
      ...
      {subTab === 'canvas' ? (
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 bg-slate-900/60 border border-slate-800/80 rounded-2xl p-3.5">
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full bg-slate-950 border border-slate-800 rounded-xl pr-10 pl-4 py-2 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-indigo-500 transition-colors"
              />
            </div>
              ...
              {filteredDrawings.map((drawing) => {
                ...
                return (
                  <div
                    ...
                    className="group bg-slate-900 hover:bg-slate-800/80 border border-slate-800 hover:border-indigo-500/50 rounded-2xl overflow-hidden transition-all duration-300 cursor-pointer shadow-lg hover:shadow-2xl hover:shadow-indigo-500/10 flex flex-col"
                  >
                    {/* Thumbnail Preview Box */}
                    <div className="relative aspect-[4/3] bg-slate-950 overflow-hidden flex items-center justify-center border-b border-slate-800/80">
                      {isImage ? (
                        <img
                      ...
                      {/* File Format Badge */}
                      <span className="absolute top-3 left-3 bg-slate-900/90 text-white font-mono text-[10px] font-bold uppercase px-2 py-0.5 rounded-lg border border-slate-700 backdrop-blur-md">
                        {drawing.file_type}
                      </span>
                    ...
                    <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
                      <div>
                        ...
                        <h4 className="text-sm font-semibold text-white line-clamp-1 group-hover:text-indigo-300 transition-colors">
                          {drawing.title}
                        </h4>
                      </div>
