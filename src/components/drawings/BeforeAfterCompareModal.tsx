...
export default function BeforeAfterCompareModal({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-background/80 backdrop-blur-md flex items-center justify-center p-4">
      <div className="bg-card border border-border rounded-2xl max-w-4xl w-full max-h-[90vh] flex flex-col overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-200">
        {/* Header */}
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-6">
          {(!beforePhoto && !afterPhoto) ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Before Photo Card */}
              <div className="bg-background border border-border rounded-2xl overflow-hidden flex flex-col">
                <div className="p-3 bg-amber-500/10 border-b border-border flex items-center justify-between">
                ...
                <div className="relative aspect-video bg-card flex items-center justify-center overflow-hidden">
                  {beforePhoto ? (
                    <img
                    ...
                    <p className="text-xs text-muted-foreground">{isAr ? 'لم ترفع صورة قبل التنفيذ' : 'No Before Photo'}</p>
                  )}
                </div>
              ...
              {/* After Photo Card */}
              <div className="bg-background border border-border rounded-2xl overflow-hidden flex flex-col">
                <div className="p-3 bg-emerald-500/10 border-b border-border flex items-center justify-between">
                ...
                <div className="relative aspect-video bg-card flex items-center justify-center overflow-hidden">
                  {afterPhoto ? (
                    ...
                    <p className="text-xs text-muted-foreground">{isAr ? 'لم ترفع صورة بعد المعالجة' : 'No After Photo'}</p>
                  )}
                </div>
